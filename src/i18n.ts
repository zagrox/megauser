...
const resources = {
  ...
  fa: {
    translation: {
      ...
      chooseSegment: 'مخاطبین خود را از یک سگمنت انتخاب کنید...',
      ...
      settingsAndTracking: 'تنظیمات پیشرفته',
      campaignName: 'نام کمپین',
      sending: 'ارسال',
      sendTimeOptimization: 'بهینه‌سازی زمان ارسال',
      sendToEngagedFirst: 'برای بهینه‌سازی تحویل، ابتدا به مخاطبین درگیرتر ارسال کنید',
      sendToEngagedFirstDesc: 'این گزینه را انتخاب کنید تا ایمیل‌های شما با شروع از درگیرترین مخاطبین ارسال شود. این ممکن است تحویل کمپین شما را بهبود بخشد.',
      sendAtOptimalTime: 'این کمپین را در زمان بهینه باز کردن هر مخاطب طی ۲۴ ساعت آینده ارسال کنید',
      sendAtOptimalTimeDesc: 'این گزینه را برای تحویل هر ایمیل در بهینه‌ترین زمان، بر اساس نرخ باز کردن مخاطب، انتخاب کنید. ممکن است برخی (یا همه) ایمیل‌ها تا ۲۴ ساعت ارسال نشوند.',
      tracking: 'ردیابی',
      trackOpens: 'ردیابی باز شدن‌ها',
      trackClicks: 'ردیابی کلیک‌ها',
